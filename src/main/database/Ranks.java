...
import static main.tools.Json.saveSimple;
...
public class Ranks {
    ...
    public void loadBuildIn() {
        ...
        candidate = new Rank(true, false, "candidate", "#" ,
                new HashMap<String, String>() {{
        ...
        admin =  new Rank(true, true, "admin", "#" ,
                new HashMap<String, String>() {{
    ...
    public Rank getRank(String name, RankType type) {
        return getRanks(type).getOrDefault(name, type == RankType.normal ? newcomer : error);
    }
